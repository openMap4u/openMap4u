...
public class TextTest extends AbstractOpenMap4uTest {
    ...
    public void testSimpleText() throws IOException {
        ...
        canvas.draw(oM4u.get(Text.class).text("Hello World").size(3).center(.5, .5));
        canvas.draw(oM4u.get(Text.class).text(true).size(3).center(4, .5));
        canvas.draw(oM4u.get(Text.class).text(1f).size(3).center(7, .5));
        canvas.draw(oM4u.get(Text.class).text(1d).size(3).center(8, .5));
        canvas.draw(oM4u.get(Text.class).text(1).size(3).center(9, .5));
        /* write the result */
    ...
    public void testTextLayout() throws IOException {
        ...
        canvas.draw(oM4u.get(Rectangle.class).width(1).center(1, 1));
        canvas.draw(oM4u.get(Text.class).text("Äg").size(7).offset(1, .5).rotate(30).scale(1.5).center(RIGHT,TOP));
        /* write the result */
