...
abstract class AbstractJava2dPlugin extends OutputFormat {
    ...
    public void drawShape(Shape shape, Point2D.Double point,
        ...
        this.mG2D
                .setStroke(new BasicStroke(
                        (float) (style.getStrokeSize() * this.mStrokeUnit2PixelFactor)));
    ...
    public void drawImage(Path path2Image, Point2D.Double point,
        ...
        try {
            ...
            AffineTransform transform = getTransform(point,
                    individualTransform, style.getHorizontalAlign(),
                    style.getVerticalAlign(), new Rectangle2D.Double(0, 0,
    ...
    public void drawText(String text, Point2D.Double point,
         ...
         * be applied
         */
        ShapeStyleable shapeStyle = new ShapeStyle()
                .setStrokeFill(style.getFontColor()).setStrokeColor(null)
                .setHorizontalAlign(style.getHorizontalAlign())
                .setVerticalAlign(style.getVerticalAlign())
        ...
        drawShape(path, point, individualTransform, shapeStyle);
