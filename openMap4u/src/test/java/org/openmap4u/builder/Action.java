...
public class Action<T> {
    ...
    public enum MockupAction {
        ...
        OFFSET_X, OFFSET_Y, SCALE_X, SCALE_Y, ROTATE, OPACITY, VERTICAL_ALIGN, HORIZONTAL_ALIGN, STROKE_COLOR, STROKE_SIZE, STROKE_FILL, FONT_SIZE, FONT_STYLE, FONT_FAMILY, FONT_COLOR, VISIBILITY
    };
    /**
     * Stores the values.
     */
