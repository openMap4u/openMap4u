...
public abstract class AbstractBuilderTest<T extends Buildable> extends
	...
	public static final Action<VerticalAlign> VERTICAL_ALIGN = new Action(
			MockupAction.VERTICAL_ALIGN, VerticalAlign.BOTTOM,
			VerticalAlign.BOTTOM, VerticalAlign.BOTTOM, VerticalAlign.MIDDLE,
			VerticalAlign.MIDDLE, VerticalAlign.MIDDLE, VerticalAlign.TOP,
			VerticalAlign.TOP, VerticalAlign.TOP, VerticalAlign.MIDDLE,
			VerticalAlign.BOTTOM);
	public static final Action<HorizontalAlign> HORIZONTAL_ALIGN = new Action(
			MockupAction.HORIZONTAL_ALIGN, HorizontalAlign.LEFT,
	...
	AbstractBuilderTest() {
		...
		mActions.add(new Actions("horizontal align", HORIZONTAL_ALIGN));
		mActions.add(new Actions("vertical align", VERTICAL_ALIGN));
		mActions.add(new Actions("align", HORIZONTAL_ALIGN, VERTICAL_ALIGN));
	}
