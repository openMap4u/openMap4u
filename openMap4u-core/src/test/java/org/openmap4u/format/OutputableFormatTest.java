...
public abstract class OutputableFormatTest extends AbstractOpenMap4uTest {
     ...
     * @throws IOException
     */
    protected final SetAreaOfInterestOrDrawOrWriteable getDraw(Class<? extends Outputable> outputableFormat) throws IOException {
    ...
    Circle getCircle() {
        return this.getDefaultOpenMap4u().get(Circle.class).diameter(1).center(1, 1);
    }
