...
public abstract class AbstractOpenMap4uTest {
     ...
     * @return
     */
    public SetAreaOfInterestOrDrawOrWriteable getCanvas(Length worldUnits,
    ...
    protected Rectangle getPointMarker(double x, double y, Paint strokeColor, Paint fillColor) {
        return this.getDefaultOpenMap4u().get(Rectangle.class).color(strokeColor).fill(fillColor).size(.25).width(.125).center(x, y);
    }
     ...
     * @return The canvas.
     */
    protected final SetAreaOfInterestOrDrawOrWriteable getCanvas(double width, double height) {
