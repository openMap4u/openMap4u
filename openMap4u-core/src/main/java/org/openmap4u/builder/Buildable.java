 ...
 *            The builder type.
 */
public interface Buildable<S extends Styleable<S>, B extends Buildable<S, B>>
		extends Drawable<S>, Plugable {
	 ...
	 *
	 * @param previousDrawnShape
	 *            The previous drawn shape (or in the case it is the first
	 *            primitive a new Rectangle2D.Double() instance).
	 */
	 ...
	 *
	 * @param tranparence
	 *            The primitives transparency.<br><br>Examples:<br>
	 *       <table summary=""><tr><td>
	 *            <code>myBuilder.transparence(0)</code></td><td><img alt="" src="./doc-files/b_transparence0.png"></td>
	 *           
	 *         <td><code>myBuilder.transparence(25)</code></td><td><img alt="" src="./doc-files/b_transparence25.png"></td>
	 *            
	 *         <td><code>myBuilder.transparence(50)</code></td><td><img alt="" src="./doc-files/b_transparence50.png"></td>
	 *           </tr>
	 *           <tr><td>
	 *            <code>myBuilder.transparence(75)</code></td><td><img alt="" src="./doc-files/b_transparence75.png"></td>
	 *            
	 *           <td> <code>myBuilder.transparence(100)</code></td><td><img alt="" src="./doc-files/b_transparence100.png"></td>
	 ...
	 * <br><br>Examples:<br>
	 *       <table summary=""><tr><td>
	 *            <code>myBuilder.align(LEFT, TOP) </code></td><td> <img alt="" src="./doc-files/b_alignLeftTop.png">
	 *            </td><td>
	 *            <code>myBuilder.align(CENTER, TOP)</code></td><td> <img alt="" src="./doc-files/b_alignCenterTop.png"> 
	 *            </td><td>
	 *            <code>myBuilder.align(RIGHT, TOP) </code></td><td> <img alt="" src="./doc-files/b_alignRightTop.png"> 
	 *            </td></tr>
	 *           <tr><td>
	 *          
	 *            <code>myBuilder.align(LEFT, MIDDLE)</code></td><td> <img alt="" src="./doc-files/b_alignLeftMiddle.png"> 
	 *          </td><td>
	 *            <code>myBuilder.align(CENTER, MIDDLE) </code></td><td> <img alt="" src="./doc-files/b_alignCenterMiddle.png"> 
	 *           </td><td>
	 *            <code>myBuilder.align(RIGHT, MIDDLE) </code></td><td> <img alt="" src="./doc-files/b_alignRightMiddle.png"> 
	 *           </td></tr>
	 *          <tr><td>
	 *            <code>myBuilder.align(LEFT, BOTTOM) </code></td><td> <img alt="" src="./doc-files/b_alignLeftBottom.png"> 
	 *            </td><td><code>myBuilder.align(CENTER, BOTTOM) </code></td><td> <img alt="" src="./doc-files/b_alignCenterBottom.png"> 
	 *            </td><td>
	 *                        <code>myBuilder.align(RIGHT, BOTTOM) </code></td><td> <img alt="" src="./doc-files/b_alignRightBottom.png"> 
	 *            </td></tr></table>
	 * @return The builder itself (fluent interface pattern).
	 */
	 ...
	 * been set).
	 *
	 * @return Determines whether the primitive is a point (=true) or not
	 *         (=false).
	 */
	boolean isPoint();
	 ...
	 * 
	 * @return Determines whether the buildable has childs (=true) or not
	 *         (=false).
	 */
